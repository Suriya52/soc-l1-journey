...
- [💼 SOC Analyst Portfolio](#-soc-analyst-portfolio)
- [🏆 Certifications](#-certifications)
- [🤝 Contribution Strategy](#-github-contribution-strategy)
- [📖 Resources](#-resources)
...
soc-l1-journey/
│
├── 📂 01-SOC-Fundamentals/       Blue team concepts, SOC roles, alert triage
...
├── 📂 18-Resources/              Curated links, books, cheat sheets
└── 📂 templates/                 Reusable report and log templates
```
...
| Platform | Focus | Link |
|----------|-------|------|
| TryHackMe | Guided labs, SOC path | [tryhackme.com](https://tryhackme.com) |
